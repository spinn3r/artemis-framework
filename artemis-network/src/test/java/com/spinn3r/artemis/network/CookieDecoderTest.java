...
public class CookieDecoderTest {
    ...
    public void testDecode() throws Exception {
        ...
        assertEquals( "Cookie{name='YSC', value='fNc9hMYIAEo', path=Optional[/], domain=Optional[.youtube.com], httpOnly=true, secure=false, maxAge=Optional.empty}",
                      cookie.toString() );
    ...
    public void testDecode1() throws Exception {
        ...
        assertEquals( "Cookie{name='foo', value='bar', path=Optional[.], domain=Optional[example.com], httpOnly=false, secure=true, maxAge=Optional.empty}",
                      cookie.toString() );
